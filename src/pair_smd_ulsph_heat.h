...
PairStyle(smd/ulsph_heat,PairULSPHHeat)

#else

#ifndef LMP_ULSPH_HEAT_H
#define LMP_ULSPH_HEAT_H
...
class PairULSPHHeat: public Pair {
public:
	PairULSPHHeat(class LAMMPS *);
	virtual ~PairULSPHHeat();
...
protected:
	...
	double *Q1, *DIFFUSIV; // linear artificial viscosity coeff
...
private:
	...
	bool density_summation, density_continuity, velocity_gradient, gradient_correction_flag, heat;
